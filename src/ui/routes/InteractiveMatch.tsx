    ...
    <div className="max-w-2xl mx-auto space-y-4">
      ...
      {ip.phase === 'PREMATCH' && (
        <div className="card p-4 space-y-3">
          ...
          ) : ip.input.occasion?.blurb ? (
            <div className="text-xs px-2.5 py-1.5 rounded border border-violet-500/40 bg-violet-500/10 text-violet-200">🏆 {ip.input.occasion.label} — {ip.input.occasion.blurb}</div>
